...
import { Star, MapPin, Wrench, Info, Phone, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 mb-4 hover:shadow-lg transition-shadow">
      ...
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-xl font-bold text-gray-800">{gmach.name}</h3>
      ...
      <div className="flex items-center gap-1 text-gray-600">
          ...
          <span className="text-sm">{gmach.city}, {gmach.address}</span>
        </div>
      ...
      <div className="flex gap-4 mb-3">
        {gmach.phone && (
          <div className="flex items-center gap-1 text-gray-600">
            ...
            <span className="text-sm" dir="ltr">{gmach.phone}</span>
          </div>
        )}
        {gmach.WhatsAppNumber && (
          <div className="flex items-center gap-1 text-green-600">
            ...
            <span className="text-sm" dir="ltr">{gmach.WhatsAppNumber}</span>
          </div>
        )}
      </div>
      ...
      {/* פריטים זמינים */}
      <div className="mb-3">
        <h4 className="text-sm font-semibold text-gray-700 mb-1">פריטים זמינים:</h4>
